...
export default {
  ...
  methods: {
    initialize: async function () {
      ...
      if(this.editedItem.datedoc===null){
        this.editedItem.datedoc = await this.getToday()
      }
      if(this.editedItem.datein!==null){
        //
        ...
        this.editedItem.isoIn = this.editedItem.datedoc + ' ' + this.leadZero(h,2) + ':' + this.leadZero(m,2) + ':' + this.leadZero(s,2)
  ...
  watch: {
    ...
    timeIn(val){
      ...
      if(val!==null){
        ...
        this.editedItem.isoIn = this.getToday() + ' ' + this.leadZero(hh,2) + ':' + this.leadZero(val.mm,2) + ':' + this.leadZero(0,2)
      }
    },
    timeOut(val){
      //
      if(val!==null){
        ...
        this.editedItem.isoOut = this.getToday() + ' ' + this.leadZero(hh,2) + ':' + this.leadZero(val.mm,2) + ':' + this.leadZero(0,2)
      }
    }
  },
  computed: {
